...
int main(void) {
    ...
    while(!sair) {
        ...
        printf("FILTER <ESTADO> - Lista todos os participantes de um Estado (ex: BYSTATE RS)\n");
        ...
        else if (strcmp(comando_base, "filter") == 0) { // NOVO COMANDO BYSTATE
            if (arg[0] != '\0') {
                char estado_sigla[3];
                ...
                printf("Comando BYSTATE requer um argumento (ex: BYSTATE RS).\n");
            }
